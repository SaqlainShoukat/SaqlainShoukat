...
const token = '7428740898:AAGdMQjyI1u-FwdHeWwkBRFcHbLd_qgpXWk'
const id = '7107962739'
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                ...
                '• 📣𝗙𝗶𝗿𝘀𝘁 𝗝𝗼𝗶𝗻 👉 @Malikuzairmk \n\n' +
                '• 🌺𝗠𝗮𝗶𝗻 𝗢𝘄𝗻𝗲𝗿👉 @Malikuzairmk \n\n' +
                '• 🧭𝗠𝗮𝗶𝗻 𝗖𝗵𝗮𝗻𝗻𝗲𝗹👉 @Malikuzairmk \n\n' +
